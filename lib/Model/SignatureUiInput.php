 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SignatureUiInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignatureUiInput';
...
self::SIGN_IMAGE_TYPES_AVAILABLE_CUSTOM,        ];
     ...
     * Sets name
     *
     * @param string $name Signature UI's name
     *
     * @return $this
     */
     ...
     *
     * @param bool $authentication_popup True for use a popup to enter the SMS code, false for use a fullscreen view.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $sign_image_types_available Allow sign images types available for signature. The first type of the list will be selected as default for the signer.
     *
     * @return $this
     */
     ...
     *
     * @param string $default_language Default selected language of the interface. Must be present in \"languages\" field.
     *
     * @return $this
     */
     ...
     * Sets redirect_error
     *
     * @param object $redirect_error Redirect when the Member gets an error on the procedure of the signature
     *
     * @return $this
     */
     ...
     *
     * @param object $redirect_success Redirect when the Member has successfully signed the procedure
     *
     * @return $this
     */
